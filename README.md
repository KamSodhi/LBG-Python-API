...
This is similar to a black box system test as we are tesing the front end with no knowledge of the back-end.

A example user acceptance test is uncluded with this project.
